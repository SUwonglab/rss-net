...
consiting of 111097 SNPs and 5345 genes.
...
The $P_1^{\sf net}$ computation is implemented in [`compute_pip`][].
...
The running time of analyzing `m0_data.mat` and `m1_data.mat`
is XXX and XXX, respectively.
